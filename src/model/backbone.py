...
class Backbone(nn.Module):
    def __init__(self, args, mode='rgbd'):
        ...
        self.former = PVT(in_chans=64, patch_size=2, pretrained="/data3/gaoyuming/Graspgan_quan/depth_quan_new/src/pretrained/pvt.pth",)
        ...
        self.dep_dec1 = conv_bn_relu(64+64, 64, kernel=3, stride=1,
                                     padding=1)
        self.dep_dec0 = conv_bn_relu(64+64, 850, kernel=3, stride=1,
